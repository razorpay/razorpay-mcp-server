...
func Test_InitiatePayment(t *testing.T) {
	...
	tests := []RazorpayToolTestCase{
		...
		{
			Name: "invalid method parameter type",
			Request: map[string]interface{}{
				"amount":   10000,
				"order_id": "order_MT48CvBhIC98MQ",
				"method":   123,
...
func Test_InitiatePaymentWithVPA(t *testing.T) {
	...
	testCases := []RazorpayToolTestCase{
		...
		{
			Name: "VPA parameter with method override",
			Request: map[string]interface{}{
				"amount":   15000,
...
//
//	processVPAParameters function scenarios
func Test_processVPAParameters_scenarios(t *testing.T) {
	tests := []struct {
		name           string
...
func Test_addAdditionalPaymentParameters_scenarios(t *testing.T) {
	tests := []struct {
		...
		{
			name: "all additional parameters provided",
			paymentData: map[string]interface{}{
				"amount":   10000,
				"currency": "INR",
			},
		...
		{
			name: "empty method parameter - not added",
			paymentData: map[string]interface{}{
				"amount": 10000,
			},
			params: map[string]interface{}{
		...
		{
			name: "nil UPI parameters - not added",
			paymentData: map[string]interface{}{
				"amount": 10000,
			},
			params: map[string]interface{}{
		...
		{
			name: "invalid UPI parameter type - not added",
			paymentData: map[string]interface{}{
				"amount": 10000,
			},
			params: map[string]interface{}{
